...
public class DeptRepositoryTest {
	...
	public void selectAll2() {
		System.out.println(deptRepository.getClass());
		Dept d10 = new Dept(new BigInteger("10"), "경리부x", "서울");
		Dept d20 = new Dept(new BigInteger("20"), "인사부x", "인천");
		Dept d30 = new Dept(new BigInteger("30"), "영업부x", "용인");
		Dept d40 = new Dept(new BigInteger("40"), "전산부x", "수원");
